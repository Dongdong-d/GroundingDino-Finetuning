...
if __name__ == "__main__":
    ...
    # check if input is a directory or a single image file
    ...
    for image_file in tqdm(image_files):
        # load image
        image_pil, image = load_image(image_file)

        # visualize raw image
        # raw_image_save_path = os.path.join(output_dir, f"raw_{os.path.basename(image_file)}")
        # image_pil.save(raw_image_save_path)
        ...
        save_path = os.path.join(output_dir, f"{os.path.basename(image_file)}")
